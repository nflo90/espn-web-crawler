...
#this may seem excessive but the table on that page does not scarpe like a normal table. to ensure each variable extracts for a team/game row format, 
#you need to set each variable and corresponding node individually
