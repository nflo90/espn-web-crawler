...
```{r write csv / clean data}
#columns to fix 
game.data.2 = game.data %>% 
  select(-home_pass_att,-away_pass_att,-home_sack,-away_sack,-home_red_zone:-away_pen,-summary_url)

#ensure numbers register as numeric columns 
game.data.2 = game.data.2 %>% mutate_at(c('home_score':'away_def_td', as.numeric))
game.data.2 = edit(game.data.2)

#write data
write.csv(game.data.2, "nfl-2021-season.csv")  
```
